...
export default function Dashboard() {
  ...
  const validateAndRefreshToken = useCallback(async () => {
    try {
      ...
      Alert.alert("Authentication Error", "There was a problem with your session.");
    } finally {
                  ...
                  {getBadge(route.name) > 0 && (
                    <View style={styles.badge}>
                      <Text style={styles.badgeText}>
                        {getBadge(route.name) > 99 ? '99+' : getBadge(route.name)}
                      </Text>
                    </View>
                  )}
                </View>
    ...
    <SafeAreaView style={styles.loadingContainer}>
      ...
      <LinearGradient colors={['#667eea', '#764ba2']} style={styles.loadingGradient}>
        <View style={styles.loadingContent}>
          <MaterialIcons name="dashboard" size={80} color="rgba(255,255,255,0.8)" />
          ...
          <View style={styles.statusContainer}>
            <View style={styles.statusItem}>
              <Ionicons 
                name={location ? 'checkmark-circle' : locationError ? 'close-circle' : 'ellipse-outline'} 
                size={16} 
                color={location ? '#4CAF50' : locationError ? '#f44336' : 'rgba(255,255,255,0.5)'} 
              />
