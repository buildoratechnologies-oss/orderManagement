...
const AttendanceList = () => {
  ...
  const { handleGetAttendanceListByUser } = useAttendanceApis();
  ...
  const fetchAttendance = async () => {
    setLoading(true);
    try {
      const response = await handleGetAttendanceListByUser();
        ...
        <View style={styles.content}>
          ...
          {filteredData.length === 0 ? (
            <View style={styles.emptyState}>
              ...
              >
                <Text style={styles.currentMonthButtonText}>View Current Month</Text>
              </TouchableOpacity>
            </View>
          ) : (
            <FlatList
